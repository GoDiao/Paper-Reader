...
class ChatAgent:
    ...
    async def chat(
        ...
        Args:
            report: The paper analysis report content
        ...
        system_prompt = CHAT_SYSTEM_PROMPT.format(report=report[:30000])  # Limit report size
    ...
    def chat_sync(
        ...
        return asyncio.get_event_loop().run_until_complete(
            self.chat(report, messages, max_tokens)
        )
